...
/* Uncomment this to turn on path counting. Its value determines how path criticality
 ...
 'R' - product of the natural e_logs of forward and backward weights
...
enum e_router_algorithm {
	BREADTH_FIRST, TIMING_DRIVEN, DIRECTED_SEARCH, NO_TIMING, READ_ROUTE
};
 ...
 * which path costs in the router have been changed.              */
...
typedef struct s_rr_node {
     ...
     * being incrementally occupied */ //added QT
